...
class HomeController extends GetxController {
  ...
  void requestToSubmitComment(String postId) async {
    final requestBody = {"comment": commentTEController.value.text};
  ...
  Future<void> submitComment(Map<String, dynamic> requestBody, String postId) async {
    ...
    try {
      ...
      final response = await NetworkCaller().postRequest(
          AppUrls.createCommentById(postId),
          body: requestBody,
          token: "Bearer ${AuthService.token}");
  ...
  Future<void> editComment(
      Map<String, dynamic> requestBody, String postId, String commentId) async {
    try {
      showProgressIndicator();
      final response = await NetworkCaller().putRequest(
          AppUrls.editCommentById(commentId),
          body: requestBody,
          token: "Bearer ${AuthService.token}");
  ...
  Future<void> deletedComment(String postId, String commentId) async {
    try {
      ...
      final response = await NetworkCaller().deleteRequest(
          AppUrls.deleteCommentById(commentId), "Bearer ${AuthService.token}");
  ...
  void requestToSubmitReply(String commentID, String postId) async {
    final requestBody = {"replyComment": commentTEController.value.text};
    await submitReply(requestBody, commentID, postId);
  }

  Future<void> submitReply(
      Map<String, dynamic> requestBody, String commentId, String postId) async {
    try {
      showProgressIndicator();
      final response = await NetworkCaller().postRequest(
          AppUrls.createReplyById(commentId),
          body: requestBody,
          token: "Bearer ${AuthService.token}");
  ...
  Future<void> editReply(
      Map<String, dynamic> requestBody, String postId, String replyId) async {
    try {
      showProgressIndicator();
      final response = await NetworkCaller().putRequest(
          AppUrls.editReplyById(replyId),
          body: requestBody,
          token: "Bearer ${AuthService.token}");
  ...
  Future<void> deletedReply(String postId, String replyId) async {
    try {
      showProgressIndicator();
      final response = await NetworkCaller().deleteRequest(
          AppUrls.deleteReplyById(replyId), "Bearer ${AuthService.token}");
