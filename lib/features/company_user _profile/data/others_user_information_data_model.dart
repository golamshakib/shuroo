...
OtherUserInformation otherUserInformationFromJson(String str) => OtherUserInformation.fromJson(json.decode(str));

String otherUserInformationToJson(OtherUserInformation data) => json.encode(data.toJson());
...
class OtherUserInformation {
    ...
    factory OtherUserInformation.fromJson(Map<String, dynamic> json) => OtherUserInformation(
