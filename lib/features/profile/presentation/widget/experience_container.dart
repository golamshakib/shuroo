...
Widget experienceContainer(PersonalCreationController controller){
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Icon(Icons.circle,color: Colors.black, size: 5.h,),
                                    ),
                                    SizedBox(
                                      width: 265.w,
                                      child: CustomText(text: objectives, fontWeight: FontWeight.w400, fontSize: 12.sp,),
                                    )
                                  ],
                                ),
                              )
