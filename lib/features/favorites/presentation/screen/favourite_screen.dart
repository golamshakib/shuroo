            ...
            child: Column(
              children: [
                ListView.builder(
                  ...
                  itemCount: controller.favoriteInformation.data != null ? controller.favoriteInformation.data!.length : 0,
                    ...
                    return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ListTile(
                              leading: ClipOval(
                                child: Image.asset(ImagePath.dummyProfilePicture, fit: BoxFit.fill, height: 34.h, width: 34.h,),
                              ),
                              title: CustomText(
                              ...
                              trailing: GestureDetector(
                                onTap: (){
                                  controller.requestToDeleteFavorite(favoritesList.id.toString());
                                },
                                child: Icon(Icons.favorite, color: AppColors.custom_blue,size: 20,),
                              ),
                            ),
                            Padding(
